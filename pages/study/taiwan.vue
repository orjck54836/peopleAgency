  ...
  <main class="main-content">
    ...
    <section class="visa-section">
      ...
      <div class="visa-list">
        <!-- 中文會話＋文化體驗 -->
        <div class="visa-item">
          <img src="../../public/images/study_taiwan/book.jpg" :alt="$t('taiwanStudy.course.conversation.alt')"
            class="visa-photo" />
          <div class="visa-text">
        ...
        <div class="visa-item reverse">
          <img src="../../public/images/study_taiwan/city_view.jpg" :alt="$t('taiwanStudy.course.culture.alt')"
            class="visa-photo" />
          <div class="visa-text">
        ...
        <!-- 企業參訪・交流學習 -->
        <div class="visa-item">
          <img src="../../public/images/study_taiwan/company.jpg" :alt="$t('taiwanStudy.course.company.alt')"
            class="visa-photo" />
          <div class="visa-text">
...
/* ====== 基本結構 ====== */
:root {
  --jp-main: var(--c-primary);
  /* 主色 */
  --jp-bg: var(--c-bg-alt);
  /* 柔米白背景 */
  --jp-text: var(--c-text-secondary);
  /* 深灰字體 */
